...
function Dente({ n, marcado, aoTocar, tamanho, x, y }) {
  return (
...
// marcados: lista de números FDI; aoAlternar ausente = só leitura (ficha)
export function Arcada({ marcados = [], aoAlternar, compacta }) {
