// Ponte NATIVA (iPhone) do Semeador: entrega o login Google pela tela de
// contas do próprio aparelho. Só isso fica gravado dentro do aplicativo —
// o código do app em si é buscado da hospedagem na hora que abre (com um
// plano B embutido para quando estiver sem internet), então as novidades
// publicadas chegam no aplicativo instalado instantaneamente.
